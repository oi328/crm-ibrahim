  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        <input className="input w-64" placeholder="Search departments" value={q} onChange={e => setQ(e.target.value)} />
        <div className="flex items-center gap-2">
          ...
          <button className="px-3 py-2 bg-green-600 text-white rounded" onClick={addDept}>Add</button>
        </div>
      </div>

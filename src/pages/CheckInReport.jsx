    ...
    <Layout titleKey="Check-in Report">
      <div className="p-4 space-y-4">
        ...
        <div className="glass-panel rounded-xl p-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input type="date" value={refDate} onChange={e=>setRefDate(e.target.value)} className="input w-full" />
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="glass-panel rounded-xl p-4">
            <h3 className="text-lg font-semibold mb-2">{t('Status Distribution')}</h3>
          ...
          <div className="glass-panel rounded-xl p-4">
            <h3 className="text-lg font-semibold mb-2">{t('Check-ins Trend')}</h3>
            <Line
              data={{
                labels: trend.labels,
                datasets: [{
          ...
          <div className="glass-panel rounded-xl p-4">
            <h3 className="text-lg font-semibold mb-2">{t('Check-ins per Staff')}</h3>
            <Bar
              data={{

...
export default function LandingPages() {
  ...
  return (
    <Layout>
      <div className="space-y-4 bg-transparent text-[var(--content-text)] overflow-x-hidden overflow-y-auto">
        {/* Page Title */}
        ...
        <section className="card glass-card p-4 max-[550px]:p-3">
          <div className="overflow-auto -mx-4 max-[550px]:-mx-3">
            <table className="nova-table w-full text-sm min-w-[800px]">
              <thead>

    ...
    <Layout>
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          <div className="glass-panel rounded-xl p-4">
            <div className="font-semibold mb-2">{isRTL ? 'الإجراءات والعمليات عبر التقارير' : 'Actions & Leads Across Reports'}</div>
            <Bar data={actionsBar} options={{ responsive: true, plugins: { legend: { position: 'bottom' } } }} />
          </div>
          <div className="glass-panel rounded-xl p-4">
            <div className="font-semibold mb-2">{isRTL ? 'الواردات/الصادرات الناجحة' : 'Successful Imports/Exports'}</div>
            <Doughnut data={importsExportsPie} options={{ responsive: true }} />
          </div>
          <div className="glass-panel rounded-xl p-4">
            <div className="font-semibold mb-2">{isRTL ? 'اتجاه الإيرادات حسب التقرير' : 'Revenue Trend by Report'}</div>

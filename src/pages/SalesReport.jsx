...
export default function SalesReport() {
  ...
  const opportunities = [
    { id: 1, name: 'Opportunity A', customer: 'Ahmed Ali', owner: 'Sara Mohamed', value: 12000, status: 'open', createdAt: '2025-10-01' },
    { id: 2, name: 'Opportunity B', customer: 'Omar Hassan', owner: 'Khaled Ibrahim', value: 8000, status: 'open', createdAt: '2025-10-05' },
    { id: 3, name: 'Opportunity C', customer: 'Layla Mohamed', owner: 'Fatima Ali', value: 15000, status: 'closed', createdAt: '2025-09-12' },
    { id: 4, name: 'Opportunity D', customer: 'Yousef Nader', owner: 'Nadia Fahd', value: 9500, status: 'missed', createdAt: '2025-10-07' },
    { id: 5, name: 'Opportunity E', customer: 'Reem Saleh', owner: 'Ahmed Ali', value: 22000, status: 'open', createdAt: '2025-08-21' },
  ]

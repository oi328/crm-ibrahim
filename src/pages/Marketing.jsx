...
export default function Marketing() {
  ...
  return (
    <Layout>
      <div className="space-y-6 bg-[var(--content-bg)] text-[var(--content-text)] overflow-x-hidden overflow-y-auto">
        {/* العنوان والأزرار */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
          ...
          {/* Top Active Table */}
          <section className="card glass-card p-4 h-[300px] overflow-hidden flex flex-col">
            <h3 className="text-lg font-semibold mb-3">{t('Campaign Management Last 30 Days')}</h3>
            <div className="overflow-auto -mx-4 flex-1">
          ...
          <div className="flex flex-col h-full gap-4">
            ...
            <section className="card glass-card p-4 flex-1 min-h-0 overflow-hidden">
              <h3 className="text-lg font-semibold mb-3">{t('Cross-Channel Performance')}</h3>
              <div className="overflow-auto -mx-4">
                <table className="nova-table w-full text-sm min-w-[420px]">
                  <thead>
                    <tr className="text-left text-gray-600 dark:text-gray-300">

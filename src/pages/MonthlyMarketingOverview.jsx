    ...
    <Layout>
      <div id="report-root" className="space-y-6">
        ...
        <section className="glass-panel p-4">
          <h3 className="text-lg font-semibold mb-3">{t('Monthly Summary')}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <section className="glass-panel p-4 md:col-span-2">
            <h3 className="text-lg font-semibold mb-3">{t('Spend vs Revenue Trend')}</h3>
          ...
          <section className="glass-panel p-4">
            <h3 className="text-lg font-semibold mb-3">{t('Leads by Platform')}</h3>
            <div style={{ height: '280px' }}>
        ...
        <section className="glass-panel p-4">
          <h3 className="text-lg font-semibold mb-3">{t('Spend Distribution by Platform')}</h3>
          <div style={{ height: '280px' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <section className="glass-panel p-4">
            <h3 className="text-lg font-semibold mb-2">📈 {t('Best Growth Area')}</h3>
            <div className="text-sm">
              {t('Revenue growth vs last month')}: +{(monthMetrics.revenue - prevMonth.revenue).toLocaleString()} EGP
            </div>
          </section>
          <section className="glass-panel p-4">
            <h3 className="text-lg font-semibold mb-2">⚠️ {t('Needs Improvement')}</h3>
            <div className="text-sm">

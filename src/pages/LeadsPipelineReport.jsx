...
export default function LeadsPipelineReport() {
  ...
  return (
    <Layout titleKey="Leads pipeline">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">{t('Funnel by Stage')}</h3>
            {(() => {
                ...
                {filtered.map((l, idx) => (
                  <React.Fragment key={`${l.name}-${idx}`}>
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      <td className="px-3 py-2 text-gray-800 dark:text-gray-100">{l.name}</td>
                      ...
                      <td className="px-3 py-2 text-gray-800 dark:text-gray-100">{`${l.expectedValue.toLocaleString()} EGP`}</td>
                      <td className="px-3 py-2 text-gray-800 dark:text-gray-100">{l.salesperson}</td>
                      <td className="px-3 py-2 text-gray-800 dark:text-gray-100">{new Date(l.dateCreated).toLocaleDateString()}</td>
                      <td className="px-3 py-2 text-gray-800 dark:text-gray-100">{t(l.status)}</td>
                    </tr>

...
// New Settings structure imports
...
import LeadsStagesStatus from './pages/LeadsStagesStatus'
...
import UserManagementUsers from './pages/UserManagementUsers'
import UserManagementUserCreate from './pages/UserManagementUserCreate'
...
import UserManagementTeams from './pages/UserManagementTeams'
import UserManagementTeamCreate from './pages/UserManagementTeamCreate'
import UserManagementTeamProfile from './pages/UserManagementTeamProfile'
import UserManagementDepartments from './pages/UserManagementDepartments'
import UserManagementDepartmentForm from './pages/UserManagementDepartmentForm'
  ...
  return (
    <div className={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
      <Routes>
        ...
        {/* Subscription guard wraps all app routes except public ones */}
        ...
        <Route element={<ProtectedModuleRoute moduleKey="leads" />}>          
          ...
          <Route path="/leads/stages-status" element={<LeadsStagesStatus />} />
        ...
        <Route element={<ProtectedModuleRoute moduleKey="campaigns" />}> 
          ...
          {/** Removed: LeadsPerformance page no longer used */}
        ...
        {/* Support / Customer Service Module */}
        ...
        <Route element={<ProtectedModuleRoute moduleKey="settings" />}> 
          ...
          <Route path="/settings/notifications/sms-templates" element={<SMSTemplates />} />
          <Route path="/settings/notifications/email-templates" element={<EmailTemplates />} />
          <Route path="/settings/notifications/whatsapp-templates" element={<WhatsAppTemplates />} />

        {/* Billing & Subscription */}
        <Route element={<BillingAdminRoute />}>
          <Route path="/settings/billing/subscription" element={<BillingSubscription />} />
        </Route>
        ...
        {/* Teams / Departments */}
        <Route path="/user-management/teams" element={<UserManagementTeams />} />
        <Route path="/user-management/teams/new" element={<UserManagementTeamCreate />} />
        <Route path="/user-management/teams/:id" element={<UserManagementTeamProfile />} />
        {/* Departments */}
        ...
        <Route path="/user-management/roles/new" element={<UserManagementRoleEdit />} />
        <Route path="/user-management/roles/:id" element={<UserManagementRoleEdit />} />
...
// Lazy-loaded Company Setup pages
